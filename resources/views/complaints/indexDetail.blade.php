        ...
        <form method="GET" autocomplete="off">
            <div class="w-full flex flex-col md:flex-row items-center justify-start pb-2">
                    ...
                    <div class="md:w-32 w-full md:mr-2 mr-0 md:mb-0 mb-2">
                        <select name="year" id="year" class="text-sm text-gray-600 rounded-lg block w-full appearance-none bg-gray-50 border border-gray-300">
                            @foreach($years as $year)
                                <option value="{{ $year }}" {{ old('year', $selected_year) == $year ? 'selected' : '' }}>{{ $year }}</option>
                            @endforeach
                        </select>
                    </div>
