                    ...
                    <div class="md:flex md:items-center mb-2">
                        ...
                        <div class="md:w-2/3">
                            <select name="category_id"
                                ...
                                <option value="{{ $category->id }}" @selected($category->id==$complaint->category_id)>{{ $category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="md:flex md:items-center mb-2">
                        ...
                        <div class="md:w-2/3">
                            <select name="channel_id"
                                ...
                                <option value="{{ $channel->id }}" @selected($channel->id==$complaint->channel_id)>{{ $channel->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="md:flex md:items-center mb-2">
                        ...
                        <div class="md:w-2/3">
                            <select name="organization_id"
                                class="bg-gray-200 appearance-none border-1 border-gray-200 rounded w-full py-2 px-4 text-gray-700 text-sm leading-tight focus:outline-none focus:bg-white focus:border-indigo-500">
                                @foreach ($orgs as $org)
                                <option value="{{ $org->id }}" @selected($org->id==$complaint->organization_id)>{{ $org->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
