<x-admin-layout>
    <div class="w-full mx-auto bg-white p-8">
        <h1 class="py-4 mb-2 mt-0 text-2xl font-medium leading-tight text-gray">Мэдээ засах</h1>
        <form action="{{ route('posts.update', $post) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title" id="title"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="{{$post->title}}"
                    required>
                @error('title')
