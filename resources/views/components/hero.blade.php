        ...
        <div class="items-center lg:flex">
            <div class="w-full lg:w-1/2">
                <div class="lg:max-w-lg">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('login') }}" class="w-full px-5 py-2 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-primary rounded-lg lg:w-auto hover:bg-primaryHover focus:outline-none focus:bg-primary">Өргөдөл, гомдол илгээх</a>
                    </div>
                </div>
            </div>
