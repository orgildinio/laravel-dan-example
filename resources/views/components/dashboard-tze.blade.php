...
<script type="text/javascript">
    ...
    const seriesDataTze = dataTze.map((item, index) => ({
       name: item.category,
       data: item.values,
       color: customColorsStacked[index]
    }));
    ...
    // Extract series data from the sample data
    const seriesDataTze2 = data2.map((item, index) => ({
       name: item.category,
       data: item.values,
       color: customColorsStacked[index]
    }));
