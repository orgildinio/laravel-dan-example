        ...
        <form method="GET" autocomplete="off">
            ...
            <div class="flex flex-row justify-start items-center">
                ...
                <div class="flex flex-row items-center space-x-2">
                    ...
                    <button type="button" onclick="exportToExcel(event, 'report-detail', 'Tailan-status')" class="flex items-center justify-center text-white bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 ml-4">Export</button>
                </div>
            </div>
        </form>
    </div>
